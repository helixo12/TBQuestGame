...
namespace TBQuestGame
{
    public class ConsoleView
    {
        ...
        public bool DisplaySpashScreen()
        {
            ...
            Console.WriteLine(tabSpace + @"                         ______       __  _______");
            Console.WriteLine(tabSpace + @"                         |____|      / / / _____ \");
            Console.WriteLine(tabSpace + @"                         | |        / / | /     \ |");
            Console.WriteLine(tabSpace + @"                         |_|___    / /  | |     | |");
            Console.WriteLine(tabSpace + @"                         |____|   / /   | |     | |");
            Console.WriteLine(tabSpace + @"                         | |     / /    | \_____/ |__");
            Console.WriteLine(tabSpace + @"                         |_|___ / /      \_______/___\");
            Console.WriteLine(tabSpace + @"                         |____|/_/ ");
            Console.WriteLine(tabSpace + @"                               Ever/Quest");
        ...
        public Traveler GetInitialTravelerInfo()
        {
            ...
            // intro
            //
            DisplayGamePlayScreen("Quest Initialization", Text.InitializeMissionIntro(), ActionMenu.MissionIntro, "");
            GetContinueKey();

            //
            // get traveler's name
            //
            DisplayGamePlayScreen("Quest Initialization - Name", Text.InitializeMissionGetTravelerName(), ActionMenu.MissionIntro, "");
            ...
            // get traveler's age
            //
            DisplayGamePlayScreen("Quest Initialization - Age", Text.InitializeMissionGetTravelerAge(traveler.Name), ActionMenu.MissionIntro, "");
            int gameTravelerAge;
            ...
            // get traveler's race
            //
            DisplayGamePlayScreen("Quest Initialization - Race", Text.InitializeMissionGetTravelerRace(traveler), ActionMenu.MissionIntro, "");
            ...
            //
            DisplayGamePlayScreen("Quest Initialization - Complete", Text.InitializeMissionEchoTravelerInfo(traveler), ActionMenu.MissionIntro, "");
            GetContinueKey();
